 ...
 * @param {function(...any): T | Promise<T>} asyncFn - The async function
 * @returns {function(...any): Promise<[E | null, T | null]>} A function that returns a Promise of either [null, result] or [error, null]
 */
